...
- **§3.3 Use version control actively** — this project is about disciplined version control; SOUL requires active use of version management for all project artefacts.
